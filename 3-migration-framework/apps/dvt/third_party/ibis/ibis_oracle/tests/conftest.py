...
OL_HOST = os.environ.get("IBIS_TEST_ORACLE_HOST", os.environ.get("OLHOST", "host"))
OL_PORT = os.environ.get("IBIS_TEST_ORACLE_PORT", os.environ.get("OLPORT", "port"))
OL_USER = os.environ.get("IBIS_TEST_ORACLE_USER", os.environ.get("OLUSER", "username"))
