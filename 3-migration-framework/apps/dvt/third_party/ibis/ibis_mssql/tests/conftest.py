...
MSSQL_USER = os.environ.get("IBIS_TEST_MSSQL_USER", os.environ.get("MSSQLUSER", "user"))
MSSQL_PASS = os.environ.get(
    "IBIS_TEST_MSSQL_PASSWORD", os.environ.get("MSSQLPASSWORD", "pas")
)
MSSQL_HOST = os.environ.get("IBIS_TEST_MSSQL_HOST", os.environ.get("MSSQLHOST", "host"))
MSSQL_PORT = os.environ.get("IBIS_TEST_MSSQL_PORT", os.environ.get("MSSQLPORT", "port"))
