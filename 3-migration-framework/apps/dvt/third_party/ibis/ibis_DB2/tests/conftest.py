...
DB2_USER = os.environ.get("IBIS_TEST_DB2_USER", os.environ.get("DB2USER", "user"))
DB2_PASS = os.environ.get(
    "IBIS_TEST_DB2_PASSWORD", os.environ.get("DB2PASSWORD", "password")
)

DB2_HOST = os.environ.get("IBIS_TEST_DB2_HOST", os.environ.get("DB2HOST", "localhost"))
DB2_PORT = os.environ.get("IBIS_TEST_DB2_PORT", os.environ.get("DB2PORT", 50000))
