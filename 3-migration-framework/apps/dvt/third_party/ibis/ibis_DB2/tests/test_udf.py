...
def con_for_udf(
    ...
    try:
        ...
        con.con.execute("DROP FUNCTION {schema}.custom_len".format(schema=test_schema))
        con.con.execute("DROP FUNCTION {schema}.pylen".format(schema=test_schema))
        con.con.execute("DROP SCHEMA {schema} RESTRICT".format(schema=test_schema))
